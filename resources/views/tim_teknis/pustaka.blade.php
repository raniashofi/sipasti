                ...
                <div class="md:hidden divide-y divide-gray-100">
                    ...
                    <div class="px-4 py-4 hover:bg-gray-50/50 transition-colors">
                        <div class="flex items-start justify-between gap-2 mb-1.5">
                            <p class="text-sm font-medium text-gray-900 leading-snug">{{ $article->nama_artikel_sop }}</p>
                            @if($article->status_publikasi === 'published')
                            <span class="inline-flex items-center text-[10px] font-bold px-2 py-0.5 rounded-full border border-green-200 text-green-600 bg-green-50 shrink-0">Published</span>
                            @else
                        ...
                        <div class="flex items-center justify-between mt-2">
                            ...
                            <a href="{{ route('tim_teknis.pustaka.show', $article->id) }}"
                               class="flex items-center gap-1 text-xs font-semibold px-3 py-1.5 rounded-lg text-white"
                               style="background-color:#01458E;">Lihat</a>
                        </div>
                    </div>
                    @empty
                    <div class="px-6 py-12 flex flex-col items-center gap-3 text-center">
                        ...
                        <p class="text-sm font-semibold text-gray-500">Belum ada artikel tersedia.</p>
                    </div>
                    @endforelse
                </div>
