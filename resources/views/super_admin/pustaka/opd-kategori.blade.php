    ...
    <div class="ml-0 lg:ml-64 min-h-screen flex flex-col"
                    ...
                    <table class="w-full min-w-[900px]">
                        <thead>
                            <tr class="border-b border-gray-100 bg-gray-50/50">
                                ...
                                <th class="px-4 py-3.5 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Judul Artikel</th>
                                ...
                                <td colspan="5" class="px-7 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-sm text-gray-500 font-medium">
                                            ...
                                            @else
                                                Belum ada artikel. Klik <strong class="text-[#01458E]">Tambah Artikel</strong> untuk memulai.
                                            @endif
                                        </p>
                                    </div>
                                </td>
                ...
                <div class="flex-1 overflow-y-auto px-6 sm:px-8 py-6 bg-white modal-scroll">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="inline-flex items-center text-[10px] font-bold px-2.5 py-0.5 rounded-full border uppercase tracking-wider"
                                  :class="preview.visibility === 'internal' ? 'border-red-200 text-red-700 bg-red-50' : 'border-blue-200 text-[#01458E] bg-blue-50'"
                                  x-text="preview.visibility === 'internal' ? 'Internal' : 'Publik'">
                            </span>
                        </div>
        ...
        <div x-show="showHapus"
            ...
            <div class="relative z-10 bg-white rounded-3xl shadow-2xl w-full max-w-sm mx-4 p-8 text-center" @click.stop>
                ...
                <h3 class="text-xl font-extrabold text-gray-900 mb-2">Hapus Artikel?</h3>
                <p class="text-sm text-gray-500 mb-8 leading-relaxed">Tindakan ini akan menghapus data secara permanen dan tidak dapat dibatalkan.</p>
