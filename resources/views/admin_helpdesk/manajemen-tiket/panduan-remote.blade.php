                    ...
                    <div class="sm:hidden divide-y divide-gray-100">
                        ...
                        <div class="px-4 py-4 hover:bg-gray-50/50 transition-colors cursor-pointer"
                            ...
                            <div class="flex items-start justify-between gap-2 mb-1">
                                ...
                                @if($hasChatM)
                                <span class="inline-flex items-center gap-1 text-[11px] font-bold px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200 shrink-0">
                                    <span class="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse shrink-0"></span>Aktif
                                </span>
                                @else
                                <span class="text-[11px] font-bold px-2 py-0.5 rounded-full bg-gray-100 text-gray-500 shrink-0">Belum Ada Chat</span>
                                @endif
                            </div>
                            ...
                            <div class="flex items-center justify-between gap-2">
                                ...
                                <div class="flex gap-1.5 shrink-0" @click.stop>
                                    ...
                                    <button @click.stop="setTiket({{ $tJM }}); showModal='transfer-pilih'"
                                            class="w-8 h-8 rounded-lg flex items-center justify-center"
                        ...
                        @empty
                        <div class="px-4 py-10 text-center text-sm text-gray-400">Tidak ada tiket dalam Panduan Remote.</div>
                        @endforelse
                    </div>
                                ...
                                <tr class="hover:bg-blue-50/50 cursor-pointer transition-colors"
                                    ...
                                    <td class="px-5 py-4 whitespace-nowrap" @click.stop>
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button type="button" @click.stop="setTiket({{ $tiketJson }}); showModal='transfer-pilih'"
