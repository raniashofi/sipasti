...
<body class="bg-[#F0F4F8] min-h-screen">
    ...
    <main class="max-w-3xl mx-auto px-6 py-10 space-y-6">
        ...
        <div class="fu fu1 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 space-y-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-base font-bold text-gray-900">{{ $profil?->nama_opd ?? '—' }}</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    <div>
                        <p class="text-xs text-gray-400 mb-1">Nama OPD</p>
                        <p class="text-sm font-medium text-gray-800">{{ $profil?->nama_opd ?? '—' }}</p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-400 mb-1">Kode OPD</p>
                        <p class="text-sm font-medium text-gray-800">{{ $profil?->kode_opd ?? '—' }}</p>
                    </div>
                    <div>
        ...
        <div class="fu fu2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <form method="POST" action="{{ route('opd.profile.password') }}" class="px-6 py-5 space-y-4">
                @csrf
