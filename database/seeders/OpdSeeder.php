...
class OpdSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = [
            ...
            // === BAGIAN SETDA ===
            ['kode_opd' => '4.01.0.00.0.00.01.0001', 'nama_opd' => 'BAGIAN HUKUM',                     'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-hukum'],
            ['kode_opd' => '4.01.0.00.0.00.01.0002', 'nama_opd' => 'BAGIAN UMUM',                      'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-umum'],
            ['kode_opd' => '4.01.0.00.0.00.01.0003', 'nama_opd' => 'BAGIAN PEREKONOMIAN',              'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-perekonomian'],
            ['kode_opd' => '4.01.0.00.0.00.01.0004', 'nama_opd' => 'BAGIAN ORGANISASI',                'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-organisasi'],
            ['kode_opd' => '4.01.0.00.0.00.01.0005', 'nama_opd' => 'BAGIAN PROTOKOL',                  'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-protokol'],
            ['kode_opd' => '4.01.0.00.0.00.01.0006', 'nama_opd' => 'BAGIAN KEUANGAN',                  'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-keuangan'],
            ['kode_opd' => '4.01.0.00.0.00.01.0008', 'nama_opd' => 'BAGIAN PENGADAAN BARANG DAN JASA', 'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-pbj'],
            ['kode_opd' => '4.01.0.00.0.00.01.0009', 'nama_opd' => 'BAGIAN PERENCANAAN',               'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-perencanaan'],
            ['kode_opd' => '4.01.0.00.0.00.01.0010', 'nama_opd' => 'BAGIAN KERJASAMA',                 'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-kerjasama'],
            ['kode_opd' => '4.01.0.00.0.00.01.0011', 'nama_opd' => 'BAGIAN ADMINISTRASI PEMBANGUNAN',  'kdunit' => null, 'parent_id' => 25, 'is_bagian' => 'Y', 'slug' => 'bag-adm-pembangunan'],
        ];
